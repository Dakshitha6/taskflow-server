...
exports.deleteTask = express_1.default.Router();
exports.deleteTask.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.body;
        if (!id) {
            return res.status(400).json({ message: "Task ID is required", status: false });
        }
        const deletedTask = yield task_model_1.TaskModel.findByIdAndDelete(id);
        if (!deletedTask) {
